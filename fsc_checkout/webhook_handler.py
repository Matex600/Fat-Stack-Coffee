...
fsc_checkout/webhook_handler.py: Contains the class StripeWH_Handler
that sends a webhook to stripe, ensure actions is done to
a safe standard.
Credit: Code Institute Boutique Ado, Stripe
